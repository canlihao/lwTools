package com.canlihao.lwutil.matisse.ui.adapter;
...
import com.canlihao.lwutil.matisse.ui.widget.MediaGrid;
...
public class AlbumMediaAdapter extends
    ...
    private int getImageResize(Context context) {
        if (mImageResize == 0) {
            ...
            int availableWidth = screenWidth - context.getResources().getDimensionPixelSize(R.dimen.activity_quart_margin) * (spanCount - 1);
