...
import com.canlihao.lwutil.CropImage;
import com.canlihao.lwutil.R;
import com.canlihao.lwutil.ToastUtil;
import com.canlihao.lwutil.Tools;
import com.canlihao.lwutil.crop.CropImageOptions;
import com.canlihao.lwutil.view.CropImageView;
...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CropImage.ActivityBuilder activityBuilder = CropImage.getActivityBuilder();
        mOptions = activityBuilder.getOptions();
        mCropImageUri = activityBuilder.getSource();
        if (mOptions != null) setTheme(mOptions.themeId);
        ...
        if (mOptions != null) {
            if (!Tools.isEmpty(mOptions.activityTitle))
                toolbar.setTitle(mOptions.activityTitle);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String permissions[], @NonNull int[] grantResults) {
        if (requestCode == CropImage.PICK_IMAGE_PERMISSIONS_REQUEST_CODE) {
            if (mCropImageUri != null
                ...
                ToastUtil.showToast(this, getString(R.string.crop_image_activity_no_permissions));
                setResultCancel();
            }
        }
