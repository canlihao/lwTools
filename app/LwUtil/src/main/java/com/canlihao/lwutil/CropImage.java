...
import com.canlihao.lwutil.ui.CropImageActivity;
...
public class CropImage {
    ...
    /**
     * The request code used to start  to be used on result to identify the
     * this specific request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link }.
     */
    ...
    public static ActivityBuilder activity() {
        activityBuilder = new ActivityBuilder(null);
        return activityBuilder;
    }

    public static ActivityBuilder activity(@Nullable Uri uri) {
        activityBuilder = new ActivityBuilder(uri);
        return activityBuilder;
    }
